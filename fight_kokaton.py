...
class Score:
    def __init__(self):
        ...
        self.txtcenter=(100,HEIGHT-50)
    
    def update(self,screen: pg.Surface):
        self.txtscore=self.fonto.render(str(self.score), 0, self.color)
        screen.blit(self.txt, self.txtcenter)
        screen.blit(self.txtscore, (200,HEIGHT-50))
